...
public partial class GamePageViewModel : BaseViewModel
{
    ...
    //[NotifyCanExecuteChangedFor(nameof(ToggleDiceCommand))]
    //public int _rollCount = 0;

    //[ObservableProperty]
    //public ObservableCollection<string> _rollCountImages = new() { CONSTANTS.ON_IMAGE, CONSTANTS.ON_IMAGE, CONSTANTS.ON_IMAGE };
    ...
    )
    {
        ...
        var fullName = Preferences.Get("Fullname", String.Empty);
    }
    ...
    //    if (!lastScore)
    //    {
    //        RollCountImages[RollCount] = CONSTANTS.OFF_IMAGE;
    //        RollCount++;
    //        DiceSet.RollDices();
    //    }
    //}
    ...
    //{
    //    DiceSet.ToggleDice((int)position);
    //}
    ...
    //    RollCount = 0;
    //    for (int i = 0; i < 3; i++)
    //        RollCountImages[i] = CONSTANTS.GREEN_LED_IMAGE;
